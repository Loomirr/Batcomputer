...
Use the normal Batcomputer UI, not only prebuilt proof paks. The character proof and latest normal build passed in-game; this matrix covers combinations those successes do not establish. Automated checks complement gameplay testing, not replace it.
