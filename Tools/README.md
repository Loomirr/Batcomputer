...
- `BatcomputerRegistryWriter` contains only the UE 5.6 project source for Batcomputer's static Asset Registry writer. Unreal creates its own `Binaries`, `Intermediate`, `Saved`, and cache folders here when an author first builds a registry.
