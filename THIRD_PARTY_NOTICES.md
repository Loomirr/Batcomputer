...
`oo2core_9_win64.dll`, Unreal Engine files, or game files.

## Other notices

The complete notices for the bundled CUE4Parse native helper and three.js are
kept in the `licenses` folder alongside this file.
